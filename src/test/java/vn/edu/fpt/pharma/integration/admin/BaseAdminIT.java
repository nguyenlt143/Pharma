...
/**
 * Base class for all Admin Integration Tests.
 */
@SpringBootTest
...
public abstract class BaseAdminIT {

    private static final Logger evidenceLogger = LoggerFactory.getLogger("ADMIN_EVIDENCE");
    ...
    protected RequestPostProcessor asAdmin() {
        return asAdmin(1L, null, "admin_user", "Administrator");
    }

    protected RequestPostProcessor asAdmin(Long userId, Long branchId, String username, String fullName) {
        Role role = new Role();
        role.setId(6L);
