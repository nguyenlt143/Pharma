...
/**
 * Base class for all Pharmacist Integration Tests.
 */
@SpringBootTest
@AutoConfigureMockMvc
@ActiveProfiles("test")
@TestPropertySource(properties = {
    "logging.config=classpath:logback-pharmacist.xml"
})
@Sql(
...
@WithMockUser(username = "pharmacist_user", roles = "PHARMACIST")
public abstract class BasePharmacistIT {

    private static final Logger evidenceLogger = LoggerFactory.getLogger("PHARMACIST_EVIDENCE");
    ...
    protected RequestPostProcessor asPharmacist() {
        return asPharmacist(6L, 2L, "pharmacist_user", "Dược sĩ");
    }

    protected RequestPostProcessor asPharmacist(Long userId, Long branchId, String username, String fullName) {
        Role role = new Role();
        role.setId(1L);
